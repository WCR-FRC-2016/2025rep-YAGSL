...
public class MoveElevatorTrophCoralAuto extends Command {
    ElevatorSubsystem elevatorSubsystem;
    ClawSubsystem clawSubsystem;
    DoubleSupplier velocity;
    double lowPosition = 0;

    public MoveElevatorTrophCoralAuto(ElevatorSubsystem elevatorSubsystem, ClawSubsystem clawSubsystem){
